...
<head>
	...
	<!--end::Base Path -->
	<meta charset="utf-8" />
	<title>Velmas 19 Lite | Dashboard</title>
	<meta name="description" content="Updates and statistics">
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

	<noscript>
        <meta http-equiv=refresh content="1; url=/logout" />
    </noscript>    <!--Obliga al uso de Javascript, si no envía fuera, en este caso tras 1"-->
	...
	<link href="{{ asset('assets/css/demo1/custom.css') }}" rel="stylesheet" type="text/css" />
	<!--end::Layout Skins -->
	
	<link rel="shortcut icon" href="https://www.Hörmann.es/fileadmin/template/layouts/ico/fav/favicon.ico" />
</head>
<!-- end::Head -->